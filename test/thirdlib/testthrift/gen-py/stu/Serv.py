...
class Processor(Iface, TProcessor):
  ...
  def process_put(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = put_result()
    result.success = self._handler.put(args.s)
...
class put_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 's', (StudentRequest, StudentRequest.thrift_spec), None, ), # 1
  )
...
class put_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (StudentResult, StudentResult.thrift_spec), None, ), # 0
  )
