...
class ServIf {
 public:
  virtual ~ServIf() {}
  virtual void put(StudentResult& _return, const StudentRequest& s) = 0;
};
...
class Serv_put_args {
 public:
  ...
  void __set_s(const StudentRequest& val) {
    s = val;
  }
...
class Serv_put_result {
 public:
  ...
  void __set_success(const StudentResult& val) {
    success = val;
  }
...
class ServClient : virtual public ServIf {
 public:
  ...
  void put(StudentResult& _return, const StudentRequest& s);
  void send_put(const StudentRequest& s);
  void recv_put(StudentResult& _return);
 protected:
