...
class CSyncFrame
{
    ...
    public:
         ...
         *  开启Hook功能
         */
        static void SetHookFlag(void);

        /**
         *  关闭Hook功能
         */
        static void SetUnHookFlag(void);

        /**
         *  设置Read超时时长
         */
        static int SetFdReadTimeout(int fd,int timeout);

        /**
         *  设置Write超时时长
         */
        static int SetFdWriteTimeout(int fd,int timeout);
